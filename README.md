...
This project provides a Gradle project template that can compile mods for Fabric, Forge, and Quilt using a common sourceset. This project does not require any third party libraries or dependencies.
...
## Template README
Under this line is a README template for your mods. Remove this and above lines.
...
Animi ea distinctio architecto cum. Suscipit non praesentium omnis recusandae. Ea qui ut tempore sequi ea officiis. Similique consequatur eaque eum nam nulla quia iure.

## Other Information:
- Report Bugs to https://github.com/dodogang/MultiLoader-Template/issues
